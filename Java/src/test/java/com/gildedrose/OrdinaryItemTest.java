...
public class OrdinaryItemTest {
  ...
  void positiveSellInTest() {
    ...
    int initialSellIn = 2;
    Item item = new Item("Ordinary item 1", initialSellIn, initialQuality);
  ...
  void negativeSellInTest() {
    int initialQuality = 10;
    int initialSellIn = 0;
    Item item = new Item("Ordinary item 1", 0, initialQuality);
    GildedRose app = new GildedRose(item);
  ...
  void minimalQualityTest() {
    Item item = new Item("Ordinary item 1", 2, 0);
    GildedRose app = new GildedRose(item);
  ...
  void minimalQualityTest2() {
    Item item = new Item("Ordinary item 1", 0, 0);
    GildedRose app = new GildedRose(item);
